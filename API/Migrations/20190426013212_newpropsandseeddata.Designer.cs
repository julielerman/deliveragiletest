            ...
            modelBuilder.Entity("AgilistaTracker.Agilista", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SecondaryFocusId = new Guid("5f6d6f80-9f9a-469e-9036-07ecbb3971ea")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            SecondaryFocusId = new Guid("c5b6a0e8-e43f-4765-906f-e15e019a19d8")
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("cb2a97da-1700-4f2b-a419-c539279e0d1f"),
                            Name = "Julie Lerman",
                            PrimaryFocusId = new Guid("a372269c-0e3d-45f6-bda1-6631667e8e37"),
                            SecondaryFocusId = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("AgilistaTracker.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a372269c-0e3d-45f6-bda1-6631667e8e37"),
                            Description = "Agile Data"
                        });
                });
